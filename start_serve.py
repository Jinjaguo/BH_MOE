'''
using this script to start the policy server
This is a WebsocketPolicyServer, 
please run serve first then run rollouts.

Usage:
cd ~/openpi
source .venv/bin/activate
python /home/jinjaguo/BH_MOE/start_serve.py --env pi0_libero

if using pi_0.5
python /home/jinjaguo/BH_MOE/start_serve.py --env pi05_libero
